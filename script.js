...
const studAdv = document.querySelector('#student-advisor')
const studMaj = document.querySelector('#student-major')
...
const sprSem = document.querySelector('#spring-semester')
const wintTerm = document.querySelector('#winter-term')
...
function updateStudentAdvisor(studentAdvisor) {
  studAdv.innerHTML = studentAdvisor
}
...
function updateMajor(studentMajor) {
  studMaj.innerHTML = studentMajor
}
